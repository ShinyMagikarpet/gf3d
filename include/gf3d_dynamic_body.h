#ifndef __GF3D_DYNAMIC_BODY_H__
#define __GF3D_DYNAMIC_BODY_H__
 ...
 * @return NULL on error or no collision, a pointer to the collision data otherwise
 */
Collision* gf3d_dynamic_body_bounds_collision_check(DynamicBody* dba, float timeStep);
