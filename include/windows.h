 ...
 */
void gf3d_windows_init(int max_windows);

/**
 * @brief draw all active windows
 */
void gf3d_windows_draw_all();

/**
 * @brief update all active windows
 */
void gf3d_windows_update_all();
 ...
 */
Window* gf3d_window_load(char* filename);

/**
 * @brief free a window no longer in use
 * @param win the window to free
 */
void gf3d_window_free(Window* win);
 ...
 */
void gf3d_window_add_element(Window* win, Element* e);

/**
 * @brief update a window and all of its elements
 * @param win the window to update
 */
void gf3d_window_update(Window* win);
 ...
 */
void gf3d_window_draw(Window* win);
 ...
 */
void gf3d_draw_window_border(Sprite* border, Sprite* bg, Rect rect, Vector4D color);
 ...
 * @param color the color to draw the window with
 */
void gf3d_draw_window_border_generic(Rect rect, Vector4D color);
 ...
 */
Element* gf3d_window_get_element_by_id(Window* win, int id);
