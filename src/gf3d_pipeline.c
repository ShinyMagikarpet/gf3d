...
Pipeline* gf3d_pipeline_basic_image_create(VkDevice device, char* vertFile, char* fragFile, VkExtent2D extent, Uint32 descriptorCount)
{
	Pipeline* pipe;
	VkRect2D scissor = { 0 };
	VkViewport viewport = { 0 };
...
void gf3d_pipeline_create_descriptor_sets(Pipeline *pipe)
{
	...
	//This is preventing the program to render more than 4 models
