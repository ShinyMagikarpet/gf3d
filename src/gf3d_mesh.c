...
void gf3d_mesh_init(Uint32 mesh_max)
{
	...
	gf3d_mesh.attributeDescriptions[3].format = VK_FORMAT_R32_SFLOAT;
	gf3d_mesh.attributeDescriptions[3].offset = offsetof(Vertex, number);
	slog("pooooooooooooooooooooooop %i", gf3d_mesh.attributeDescriptions[3].offset);*/
	//gf3d_mesh.attributeDescriptions[3]
