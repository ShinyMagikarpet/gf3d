...
Collectable* Collectable_New(Vector3D position, CollectableColor color) {
	...
	case Collectable_Red:
		...
		collectable->sprite = gf3d_sprite_load("images/red.png", 64, 64, 1, 1, 0, NULL);
	...
	case Collectable_Blue:
		...
		collectable->sprite = gf3d_sprite_load("images/blue.png", 64, 64, 1, 1, 0, NULL);
	...
	case Collectable_Yellow:
		...
		collectable->sprite = gf3d_sprite_load("images/yellow.png", 64, 64, 1, 1, 0, NULL);
